<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="pms.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        <div style="text-align: right">
            <asp:Button ID="Button1" runat="server" style="text-align: right; background-color: #99CCFF;" Text="LogOut" CssClass="auto-style2" OnClick="Button1_Click" />
        </div>
        <p class="auto-style1">
            Employee Report</p>
        <p class="auto-style4">
