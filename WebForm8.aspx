<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="pms.WebForm8" %>
...
<body style="font-size: x-large">
    <form id="form1" runat="server">
        ...
        <p style="text-align: center" class="auto-style3">
            &nbsp;<strong><em>Search Class</em></strong></p>
        <p style="text-align: center" class="auto-style3">
            <span class="auto-style4">Class Code&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp; </span>&nbsp;<asp:TextBox ID="TextBox8" runat="server" Height="30px" Width="133px"></asp:TextBox>
        </p>
        <p style="text-align: center" class="auto-style3">
            <asp:Button ID="Button5" runat="server" CssClass="auto-style5" Height="30px" OnClick="Button5_Click" Text="Search" Width="75px" />
        </p>
        <p style="text-align: center" class="auto-style3">
            <strong><em>Update/Delete Class</em></strong></p>
        <p style="text-align: center" class="auto-style3">
        ...
        <p style="text-align: center">
            <asp:Button ID="Button1" runat="server" Height="35px" OnClick="Button1_Click" style="color: #003399; background-color: #99CCFF" Text="Update" Width="80px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Height="35px" OnClick="Button2_Click" style="color: #003399; background-color: #99CCFF" Text="Delete" Width="80px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
